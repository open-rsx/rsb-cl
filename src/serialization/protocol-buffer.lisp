...
(defmethod find-serialization-class ((spec (eql :rsb-0.8/protocol-buffer)))
  (find-class 'protocol-buffer))
...
contained in NOTIFICATION."
  (let+ (((&accessors-r/o
	   (expose-wire-schema?  serialization-expose-wire-schema?)
	   (expose-payload-size? serialization-expose-payload-size?))
	  serialization)
