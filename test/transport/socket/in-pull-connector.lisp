;;; in-pull-connector.lisp --- Unit tests for the in-pull-connector class
;;
...
(deftestsuite in-pull-connector-root (transport-socket-root
				      connector-suite)
  ()
  (:documentation
   "Test suite for the `in-pull-connector' class."))
...
(addtest (in-pull-connector-root
          :documentation
	  "Test constructing `in-pull-connector' instances.")
  construction

  (ensure-condition 'missing-required-initarg
    (make-instance 'in-pull-connector)))
